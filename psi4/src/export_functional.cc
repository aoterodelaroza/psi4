...
void export_functional(py::module &m) {
    py::class_<SuperFunctional, std::shared_ptr<SuperFunctional>>(m, "SuperFunctional", "docstring")
        ...
        .def("xdm_a1", &SuperFunctional::xdm_a1, "XDM a1 parameter.")
        .def("xdm_a2", &SuperFunctional::xdm_a2, "XDM a2 parameter.")
        .def("xdm_vol", &SuperFunctional::xdm_vol, "XDM volume token.")
        ...
        .def("needs_xdm", &SuperFunctional::needs_xdm, "Does this functional need XDM dispersion.")
