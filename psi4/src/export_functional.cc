...
void export_functional(py::module &m) {
    py::class_<SuperFunctional, std::shared_ptr<SuperFunctional>>(m, "SuperFunctional", "docstring")
        ...
        .def("xdm_a1", &SuperFunctional::vv10_b, "XDM a1 parameter.")
        .def("xdm_a2", &SuperFunctional::vv10_c, "XDM a2 parameter.")
        ...
        .def("set_xdm_a1", &SuperFunctional::set_vv10_b, "Sets the XDM a1 parameter.")
        .def("set_xdm_a2", &SuperFunctional::set_vv10_c, "Sets the XDM a2 parameter.")
        ...
        .def("needs_xdm", &SuperFunctional::needs_vv10, "Does this functional need XDM dispersion.")
    ...
    py::class_<XDMDispersion, std::shared_ptr<XDMDispersion>>(m, "XDMDispersion", "docstring")
        .def_static("build", &XDMDispersion::build, "a1"_a = 0.0, "a2"_a = 0.0, "Initialize instance capable of computing a dispersion correction of *type*")
